...
public sealed class HfConfigurationManager {
    ...
    public HfConfigurationManager(HenderschefuereBuilder henderschefuereBuilder)
        : this() {
        this.SetHenderschefuereConfiguration(henderschefuereBuilder.Configuration);
    }
    ...
    public void SetHenderschefuereConfiguration(HfConfiguration hfConfiguration) {
        if (ReferenceEquals(this._SourceConfiguration, hfConfiguration)) { return; }
