...
/// </summary>
public sealed class ConfigurationConfigProvider : IProxyConfigProvider, IDisposable {
    ...
    private static SessionAffinityCookieConfig? CreateSessionAffinityCookieConfig(IConfigurationSection section) {
        ...
        return new SessionAffinityCookieConfig {
            ...
            SameSite = section.ReadEnum<Microsoft.AspNetCore.Http.SameSiteMode>(nameof(SessionAffinityCookieConfig.SameSite)),
